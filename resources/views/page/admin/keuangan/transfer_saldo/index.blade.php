    ...
    <div class="card">
        ...
        <div class="card-body p-0" style="margin: 20px">
            ...
            <div class="d-flex flex-row bd-highlight mb-4">
                ...
                <div class="p-2">
                    <form method="post" action="{{route('importtransfer.index')}}" enctype="multipart/form-data" class="form-inline">
                        @csrf
            ...
            <table id="previewTransfer" class="table table-striped table-bordered display" style="width:100%">
                <thead>
                    <tr>
                        <th>Nomor</th>
